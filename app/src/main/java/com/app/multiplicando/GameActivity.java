...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button but1 = findViewById(R.id.Button01);
        Button but2 = findViewById(R.id.Button02);
        Button but3 = findViewById(R.id.Button03);
        Button but4 = findViewById(R.id.Button04);
        Button but5 = findViewById(R.id.Button05);
        Button but6 = findViewById(R.id.Button06);
        Button but7 = findViewById(R.id.Button07);
        Button but8 = findViewById(R.id.Button08);
        Button but9 = findViewById(R.id.Button09);
        Button but10 = findViewById(R.id.Button10);
